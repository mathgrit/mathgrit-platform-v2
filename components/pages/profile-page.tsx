...
export default function ProfilePage() {
  ...
  const stats = [
    { label: "Total XP", value: user.xp.toLocaleString(), icon: Trophy, color: "text-blue-600 dark:text-cyan-400" },
    { label: "Current Streak", value: `${user.streak} days`, icon: Flame, color: "text-orange-500" },
    { label: "Level", value: user.level.toString(), icon: Star, color: "text-purple-500" },
    { label: "Member Since", value: "Jan 2024", icon: Calendar, color: "text-green-500" },
  ]
  ...
  const badges = [
    ...
    {
      name: "Math Olympian",
      description: "Solve an IMO problem",
              ...
              <CardContent>
                <div className="grid gap-4">
                  {badges.map((badge, index) => (
                    <div
                      key={index}
                      className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-[#415a77]/20"
                    >
