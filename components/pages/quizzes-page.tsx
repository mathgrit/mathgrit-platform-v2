                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center text-gray-500 dark:text-gray-400 text-sm">
                      ...
                      {/* DIUBAH: Ditambahkan '?? 0' untuk memberi nilai default jika 'completions' tidak ada */}
                  ...
                  <Button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 dark:bg-cyan-600 dark:hover:bg-cyan-700 group-hover:scale-105 transition-transform duration-200"
                  >
                    Start Quiz
          ...
          <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto p-0">
            {selectedQuiz && (
              <InteractiveQuiz
                ...
                onClose={() => setSelectedQuiz(null)} // <-- TAMBAHKAN PROP INI
              />
            )}
          </DialogContent>
        </Dialog>
